...
printf '\n\e[5;33m%-6s\e[m\n\n' "-------------------------------------"
cp -r build/* /Volumes/staging/arte.folha.com.br/equilibrioesaude/2020/historias-das-vitimas-do-novo-coronavirus/


printf '\n\e[5;33m%-6s\e[m\n' "Url:"
printf '\e[1;33m%-6s\e[m\n\n' "http://staging.arte.folha.com.br/equilibrioesaude/2020/historias-das-vitimas-do-novo-coronavirus/"
